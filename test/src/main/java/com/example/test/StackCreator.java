...
public class StackCreator extends StackImpl {
    ...
    public StackCreator(Configuration config, NetworkReqListener networkReqListener, EventListener<Request, Answer> eventListener, String identifier) {
        ...
        try {
            ...
            for (ApplicationId appId : appIds) {
                ...
                // theo cac listener ung voi cac applicatipon trong file config
    ...
    public StackCreator(InputStream streamConfig, NetworkReqListener networkReqListener, EventListener<Request, Answer> eventListener, String dooer) throws Exception {
    this(new XMLConfiguration(streamConfig), networkReqListener, eventListener, dooer);
    }
    ...
    public StackCreator(String stringConfig, NetworkReqListener networkReqListener, EventListener<Request, Answer> eventListener, String dooer, Boolean isServer)
        throws Exception {
    this(new XMLConfiguration(new ByteArrayInputStream(stringConfig.getBytes())), networkReqListener, eventListener, dooer);
    }
